...
<div class="span4" id="sidebar">
 <h1 class="text-muted">${medico}</h1>
 
 <form action="" id="cadastroMedico">
 <fieldset>
 <legend></legend>
 
 <input type="text" id="nome" placeholder="Nome Completo" class="form-control" size="50">
  <input type="text" id="cpf" placeholder="CPF/CNPJ" class="form-control" size="50">
 <input type="text" id="crm" placeholder="CRM" class="form-control" size="50">
 <input type="text" id="rg" placeholder="CRM" class="form-control" size="50">

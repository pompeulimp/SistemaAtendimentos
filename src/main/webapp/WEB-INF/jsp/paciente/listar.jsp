...
<body>
	...
	<c:forEach items="${pacienteList}" var="paciente">
		<div>${paciente.nomePaciente}
			...
			<a href="${linkTo[PacienteController].editar}?pkKLey=${paciente.pk_paciente}">Editar</a>		 
			<a href="${linkTo[PacienteController].deletar}?pkKLey=${paciente.pk_paciente}">deletar</a>
		</div>
	</c:forEach>
</body>
</html>